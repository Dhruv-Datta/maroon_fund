...
Strategy: 3% of capital per trade, execute on every signal.
"""
import pandas as pd
import numpy as np
...
class PortfolioAllocator:
    ...
    def execute_sell_signal(self, date: str, ticker: str, price: float, signal_prob: float):
        """
        Execute a sell signal - SELL ALL POSITIONS for the ticker
        ...
        # Sell ALL shares (100% of position)
        ...
        if net_proceeds > 0 and shares_to_sell > 0:
            ...
            # Remove position completely (sold all shares)
