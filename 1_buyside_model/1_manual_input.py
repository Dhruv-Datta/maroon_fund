...
# Clear utils.csv, make the user enter a custom stock, date, etc
#with open(os.path.abspath('../QR/x_utilities/utils.csv'), 'w', newline='') as file:
#    pass 

utils.getInfo()

# read what the user wrote
with open(os.path.abspath('../QR/x_utilities/utils.csv'), 'r') as csvfile:
...
# Drop raw columns
drop_cols = ['Open', 'High', 'Volume', 'Daily_Return', 'Roll_Vol_20d', 'OBV', 'Dividends', 'Stock Splits', 'Capital Gains']
